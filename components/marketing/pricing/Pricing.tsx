        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24">
          ...
          <div className="mt-14 grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
             {(Object.entries(PLANS) as [Plan, PlanDetails][]).map(([planName, data]) => (
              <div
                key={planName}
                className={`relative rounded-2xl border border-border p-7 flex flex-col ${
                  data.popular
              ...
              >
                ...
                <Link
                  ...
                  className={`mt-7 inline-flex items-center justify-center px-4 py-2.5 rounded-xl font-medium transition ${
                    data.popular
